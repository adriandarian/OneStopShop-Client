...
import UsersList, { UsersListQuery } from '.';
...
describe('UsersList', () => {
  ...
  it('triggers onUserPick() callback on user-item click', async () => {
...

    {
      ...
      expect((onUserPick as any).mock.calls[0][0].name).toEqual('Charles Dickhead');
      expect((onUserPick as any).mock.calls[0][0].picture).toEqual(
        'https://localhost:4000/dick.jpg'
      );
    }
  });
